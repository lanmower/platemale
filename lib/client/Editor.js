...
var _require = require('meteor/themeteorchef:bert'),
    Bert = _require.Bert;
...
function (_React$Component) {
  ...
  _createClass(Editor, [{
    ...
    value: function handleSubmit() {
      ...
      var submit = {};
      schema.map(function (field) {
        submit[field.name] = _this2.state[field.name];
      });
      if (existing) submit._id = existing;
      Meteor.call(methodToCall, submit, function (error, id) {
        if (error) {
    ...
    value: function render() {
      ...
      return _react.default.createElement("form", {
        ...
        var value = _this3.state[field.name] ? _this3.state[field.name] : field.default;
        var newState = {};
        field.view = 'form';
