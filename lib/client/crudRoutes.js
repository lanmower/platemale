...
var _NavigationPage = _interopRequireDefault(require("../navigation/client/NavigationPage"));
...
var defaultRoutes = function defaultRoutes(collections) {
  ...
  var routes = [];
  if (config.defaultRoutes.new) routes.push(newRoute({
    collections: collections,
    config: config
  }));
  if (config.defaultRoutes.edit) routes.push(editRoute({
    collections: collections,
    config: config
  }));
  if (config.defaultRoutes.view) routes.push(viewRoute({
    collections: collections,
    config: config
  }));
  if (config.defaultRoutes.list) routes.push(listRoute({
    collections: collections,
    config: config
  }));
