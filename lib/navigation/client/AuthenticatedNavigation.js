...
function (_React$Component) {
  ...
  function Navigation() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleClickMenu", function (event) {
      _this.setState({
        anchorEl: event.currentTarget
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMenuItemClick", function (event, index, history, options) {
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement(_IconButton.default, {
      ...
      }, _react.default.createElement(_Menu2.default, null)), _react.default.createElement(_Menu.default, {
        id: "lock-menu",
        anchorEl: anchorEl,
        ...
        return _react.default.createElement(_MenuItem.default, {
          ...
          onClick: function onClick(event) {
            return _this2.handleMenuItemClick(event, index, history, options);
          }
        }, option.title);
