...
var Authenticated = function Authenticated(_ref) {
  var loggingIn = _ref.loggingIn,
      authenticated = _ref.authenticated,
      component = _ref.component,
      rest = _objectWithoutProperties(_ref, ["loggingIn", "authenticated", "component"]);

  return _react.default.createElement(_reactRouterDom.Route, _extends({}, rest, {
    render: function render(props) {
      return authenticated ? _react.default.createElement(component, _objectSpread({}, props, {
        loggingIn: loggingIn,
...
Authenticated.propTypes = {
  loggingIn: _propTypes.default.bool.isRequired,
